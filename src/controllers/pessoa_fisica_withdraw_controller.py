...
class PessoaFisicaWithdrawController:
  ...
  def __validate_withdrawal_value(self, withdraw_value):
    ...
    if withdraw_value >= 50000:
      raise ValueError('Limite máximo de saque permitido para pessoa física de $50.000')
